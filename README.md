...
**不做因果宣稱。** 四種識別策略各自被一個具體事實擋掉：

- **資料停更** — M-Lab 的 ISP 級測速資料 2024-03 全球停更，2026 年的事件無資料可用。
- **後測期不足** — 即使有資料，2026-03 事件至今僅 4.5 個月，估不出穩定效果。
- **無業者別** — 政府統計只有技術別，做不出 treatment／control 分組。
- **對照組自己被處理** — 改用技術陣營分組後，2022 年的價格戰由對照組（有線電視業者）發動。

圖上的事件時點只是視覺標記，不估計任何效果。
